...
int process_string(const char *format, char *buffer, va_list arg, int *total_printed);
...
int handle_basic_formats(char *buffer, const char specifier, va_list args, int *buff_index, int *total_printed);
